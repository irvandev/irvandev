...
function showLabels(json) {
	var cat = json.feed.category, skeleton = "<select id='labelSorter' onchange='changeSort(this.value);'><option value='' selected disabled>KATEGORI...</option>";
